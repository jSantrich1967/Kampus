  ...
  try {
    return await runOpenAiRoute("class_presentation", async () => {
      ...
      const user = [
        ...
        "subjectLine, intro, slides",
        "",
        "Reglas:",
        "- intro: 1–2 frases de bienvenida a la clase visual.",
        "- slides: entre 5 y 10 diapositivas ordenadas pedagógicamente.",
        "- Cada slide: id (string único), title, narration (2–4 frases habladas para voz), bullets (2–4 puntos cortos), diagram (objeto o null).",
        "- diagram: { type: 'flow'|'compare'|'list', items: [{ label, detail? }] } con 2–4 items máximo.",
        "- Usa sourcePageNumber, sourceDocumentId y sourceFilename cuando encaje con una hoja de la lista.",
        "- narration debe sonar natural al leerla en voz alta.",
        "",
