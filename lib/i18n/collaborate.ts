...
> = {
  es: {
    ...
    rosterHint: "Añade alumnos con su correo de Kampus.",
    rosterEnrolledLabel: "inscritos",
    rosterSeatsLeft: "cupos libres",
    rosterFull: "Sin cupo",
    rosterAddPlaceholderEmailOrUuid: "correo@ejemplo.com",
    ...
    createSessionEmbedUrl: "Video para mostrar en clase (opcional)",
    createSessionEmbedHint: "Si lo dejas vacío, detectamos el video desde el enlace de la videollamada.",
    ...
    hubFeatureScheduleSync: "Tu horario, al día",
    ...
    participationHint:
      "Señales en tiempo real mientras tus alumnos tienen abierta la página de la sesión.",
    ...
    classroomDemoFootnote: "La demo incluye vídeo de ejemplo y empieza en ~15 minutos.",
    ...
    classroomDemoError: "No se pudo crear la demo. Inténtalo de nuevo en un momento.",
    ...
    presentationsSteps:
      "1) Carga la demo o crea una presentación · 2) Invita al equipo con el enlace · 3) Ensaya con cámara · 4) Pide feedback al tutor IA.",
    presentationsLocalOnlyHint:
      "Tus datos quedan solo en este navegador. Inicia sesión para verlos en tus otros dispositivos.",
    ...
    presentationsDemoCreatedOk: "Exposición demo creada — revisa la presentación activa abajo.",
    ...
    presentationsDemoError: "No se pudo crear la demo. Inténtalo de nuevo en un momento.",
    ...
    researchFeatureCalendar: "Se refleja en Mi calendario",
    ...
    researchLocalOnlyHint:
      "Tus trabajos quedan solo en este navegador. Inicia sesión para verlos en tus otros dispositivos.",
    ...
    researchDemoError: "No se pudo crear la demo. Inténtalo de nuevo en un momento.",
  },
};
