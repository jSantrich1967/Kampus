...
> = {
  es: {
    ...
    simulatorPremiumTitle: "Función Premium",
    simulatorPremiumHint:
      "Gratis: 1 pregunta de vista previa. Premium desbloquea las 3 rondas completas con rúbrica.",
    simulatorPremiumCta: "Ver planes Premium",
    ...
    simulatorUnlockAll: "Desbloquear las 3 preguntas",
